...
public class update_teacher extends JFrame implements ActionListener{
 ...
 JLabel l1, l2, l3;
    ...
    JPanel p1, p2, p3;
    Font f;
    String x[] = {"employno", "Name", "Father's Name", "Age", "DOB", "Address", "Phone", "Email", "Class X", "Class XII", "Branch", "Course"};
    ...
    update_teacher() {
        ...
        l1 = new JLabel("Enter employ number to delete teacher");
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (ev.getSource() == bt1) {
            if (rollno.isEmpty()) {
                ...
                try {
                    connection obj = new connection();
                    String qq = "delete from new_faculty where employ_id='" + rollno + "'";
        ...
        if (ev.getSource() == bt3) {
            new updateTeacher_record(rollno).setVisible(true);
            setVisible(false);
        }
    }
